...
**Jawaban:**
Kendala yang sering muncul adalah adanya _noise_ elektrikal yang dihasilkan oleh beban PWM (seperti motor atau LED daya tinggi) yang masuk ke jalur analog ADC. Hal ini dapat menyebabkan pembacaan ADC menjadi tidak stabil atau "melompat-lompat". Selain itu, keterbatasan kecepatan pemrosesan (latency) dalam loop program dapat menyebabkan keterlambatan respon sistem antara perubahan input analog terhadap perubahan output PWM.
